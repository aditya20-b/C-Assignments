...
STRINGS_EXECS = $(STRINGS_DIR)/matrix_operations $(STRINGS_DIR)/palindrome $(STRINGS_DIR)/remove_vowels $(STRINGS_DIR)/sorting_and_searching $(STRINGS_DIR)/string_compare $(STRINGS_DIR)/string_reverse $(STRINGS_DIR)/string_to_ascii
